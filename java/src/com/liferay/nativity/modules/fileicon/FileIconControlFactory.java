...
FileIconControlFactory fileIconControlFactory = new FileIconControlFactory(
nativityControl, fileIconControlCallback);

if (OSDetector.isApple()) {
_fileIconControl = fileIconControlFactory.createAppleFileIconControl();
}
else if (OSDetector.isWindows()) {
_fileIconControl = fileIconControlFactory.createWindowsFileIconControl();
}
else if (OSDetector.isLinux()) {
_fileIconControl = fileIconControlFactory.createLinuxFileIconControl();
}
}
...
return new AppleFileIconControlImpl(_nativityControl, _fileIconControlCallback);
}
